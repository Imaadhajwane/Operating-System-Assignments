...
int main() {
    pthread_t writer1_thread, writer2_thread, writer3_thread, reader1_thread, reader2_thread, reader3_thread;

    pthread_create(&writer1_thread, NULL, writer, (void *)1);
    pthread_create(&writer2_thread, NULL, writer, (void *)2);
    pthread_create(&writer3_thread, NULL, writer, (void *)3);
    ...
    pthread_join(writer3_thread, NULL);
